...
const orderStatus=[
    {label: "Комплектование заказа", value: "creating_order"},
    {label: "В пути", value: "on_the_wey"},
    {label: "Доставлен в пункт выдачи", value: "on_the_store"},
        ...
        <Grid container sx={{justifyContent:"space-between"}}>
            <Grid item xs={2.5}>
                <div className='h-auto shadow-lg bg-white p-5 sticky top-5'>
                    <h1 className='font-bold text-lg'>Фильтры:</h1>
                    <div className='space-y-4 mt-10'>
                        <h1 className='font-semibold'>Статус заказа:</h1>
